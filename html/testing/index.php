...
$conn = new myusqli($servername, $username, $password, $dbname);
...
if ($result->num_rows > 0) {
	while ($row = $result->fetch_assoc()){
		echo "<br> Username: " . $row{"name"} . " - favorite thing: " . $row{"ItemName"} . "<br>";
	}
} else {
	echo "0 results";
}
...
|       `-- *.conf
    ...
    <div class="validator">
     ...
     <p><a href="https://www.siena.edu/departments/computer-science/">Computer Science Department's Home Page </a></p>
     <p><a href="/cgi-bin/datetime.pl">Hello World?</a></p>
  </body>
</html>
